...
public class StreamingFlowJob4ExecuteNoMonitorTest extends AbstractBaseStdJobAutoInitTest {

	public StreamingFlowJob4ExecuteNoMonitorTest() {
	...
	protected void setFactJobConfig(final FactJobConfiguration factJobConfig) {
		JobConfigUtils.setFieldValue(factJobConfig, "monitorExecution", false);

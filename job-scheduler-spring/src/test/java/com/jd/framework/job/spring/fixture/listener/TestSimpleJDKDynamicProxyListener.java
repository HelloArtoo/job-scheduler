...
public class TestSimpleJDKDynamicProxyListener implements ScheduleJobListener {

	@Override
	public void beforeJobExecuted(SegmentContexts segmentContexts) {
		assertThat(segmentContexts.getJobName(), is("testSpringSimpleJob_namespace_listener_jdk_proxy"));
